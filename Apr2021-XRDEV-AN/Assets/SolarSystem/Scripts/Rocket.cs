...
public class Rocket : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKey(KeyCode.W))
        {
            rocketRigidBody.AddForce(Vector3.forward * Time.deltaTime * moveSpeed);
        }
        ...
        {
            rocketRigidBody.AddForce(Vector3.left * Time.deltaTime * moveSpeed);
        }
        // move right
        if (Input.GetKey(KeyCode.D))
        {
            rocketRigidBody.AddForce(Vector3.right * Time.deltaTime * moveSpeed);
        }
